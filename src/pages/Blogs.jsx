      ...
      <div className="w-[75vw] h-[15rem] flex">
        ...
        <div className="w-9/12 bg-white h-full rounded-md boxes text-[#BDA9A9]">
          <div className="h-full w-full pl-[8rem] py-4 pr-8 flex flex-col justify-between">
            <div>
              <h1 className="text-[#222629] text-lg font-bold">{blog.title}</h1>
            ...
            <div className="flex justify-start">
              <h1 className="text-sm h-full flex content-end">#{blog.tag}</h1>
              {"    "}
              {blog.company && (
              ...
              <input
                ...
                onKeyDown={(e) => {
                  if (e.key === "Enter") {
                    ...
                    setData(
                      blogs.filter(
                        (blog) => blog.company.toLowerCase() === inputValue
                      )
                    );
                    inputRef.current.blur();
                  }
