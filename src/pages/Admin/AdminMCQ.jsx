  ...
  const handleUpload = async () => {
    ...
    for (let i = 0; i < uploadData.options.length; i++) {
      if (
        ...
        swal("Please Either fill all the options or remove the empty options!");
        return;
      }
    }
    ...
    for (let i = 0; i < uploadData.options.length; i++) {
      if (uploadData.options[i].image && uploadData.options[i].image !== "") {
        const cloudUrl = await addUploadImage(uploadData.options[i].image);
  ...
  const handleEdit = async () => {
    ...
    for (let i = 0; i < editData.options.length; i++) {
      if (editData.options[i].image && editData.options[i].image !== "") {
        const cloudUrl = await addUploadImage(editData.options[i].image);
                    ...
                    {!loading ? (
                      <div className="w-full flex justify-center items-center flex-col py-4">
                        ...
                        <div className={divStyle}>
                          ...
                          {uploadData.options.map((item, index) => (
                            <div
                            ...
                            >
                              ...
                              <div className="w-3/12 flex justify-center items-center gap-2">
                                ...
                                {index == uploadData.options.length - 1 && (
                                  <button
                                    className="w-[100px] h-[40px] bg-[#1E1E1E] text-white rounded-md"
                                    onClick={() => {
                                      let temp = uploadData.options;
                  ...
                  <div>
                    <div className="h-[100%] overflow-auto modals text-[0.76rem]">
                      ...
                      <div className="px-8 w-full flex flex-col gap-2  text-[0.9rem]">
                        <span className={`text-[#E97500] font-bold`}>
                          Question
                        </span>{" "}
                        <span className={`text-[#202128] font-bold`}>
                          {editData.question}
                        </span>
                      </div>
                          ...
                          editData.options.map((item, index) => (
                            <div key={index}>
                              ...
                              >
                                ...
                                {editData.answer.includes(index + 1) && (
                                  <span className={`text-[#E97500] font-bold`}>
                                    Answer
                                  </span>
                                )}
                      ...
                      {editData.topicTag && editData.topicTag != "" && (
                        <div className="px-8 w-full flex flex-col gap-2 mt-8">
                          <span
                            className={`text-[#E97500] font-bold text-[0.9rem]`}
                          >
                        ...
                        {editData.options.map((item, index) => (
                          ...
                          >
                            ...
                            <div className="w-3/12 flex justify-center items-center gap-2">
                              ...
                              {index == editData.options.length - 1 && (
                                <button
                                  className="w-[100px] h-[40px] bg-[#1E1E1E] text-white rounded-md"
                                  onClick={() => {
                                    let temp = editData.options;
