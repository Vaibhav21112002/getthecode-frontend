...
const AdminProgramming = () => {
    ...
    const handleUpload = () => {
        if (
            ...
            uploadData.solution === "" ||
            uploadData.testCases.testCase1.input === "" ||
            uploadData.testCases.testCase1.output === "" ||
            uploadData.testCases.testCase1.explaination === "" ||
            uploadData.testCases.testCase2.input === "" ||
