            ...
            <div className="w-full flex flex-wrap gap-4">
              ...
              >
                <select
                  ...
                  onChange={(e) => difficultyFilter(e.target.value)}
                ...
                >
                  ...
                  <option value="easy" className="text-[#008000]">
                    Easy
                  </option>
                  <option value="medium" className="text-[#FFA500]">
                    Medium
                  </option>
                  <option value="hard" className="text-[#FF0000]">
                    Hard
                  </option>
                </select>
              </div>
